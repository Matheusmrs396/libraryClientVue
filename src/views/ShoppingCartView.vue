...
const columns = [
  ...
  { name: 'Categoria', align: 'center', label: 'Categoria', field: row=> row.category.description, sortable: true },
  { name: 'Autor', label: 'Autor', field: row=> row.author.name, sortable: true },
